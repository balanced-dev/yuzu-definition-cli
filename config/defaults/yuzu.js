module.exports = (config) => {
  ...
  config.processors.splice(0, 0, { name: 'directories', module: require('../../creation/creators/directories') });
  config.processors.splice(1, 0, { name: 'data', module: require('../../creation/creators/data') });
